...
const authDemoNavigationConfig: NavigationTree[] = [
    {
        key: 'authentication',
        path: '',
        ...
        subMenu: [
            {
                ...
                subMenu: [
                    ...
                    },
                    {
                        ...
                        title: 'Centred',
                        translateKey: 'nav.authentication.signInCentred',
                        icon: '',
                        type: NAV_ITEM_TYPE_ITEM,
                        authority: [ADMIN, USER],
                        subMenu: [],
            ...
            },
            {
                ...
                subMenu: [
                    ...
                    },
                    {
                        ...
                        title: 'Centred',
                        translateKey: 'nav.authentication.signUpCentred',
                        icon: '',
                        type: NAV_ITEM_TYPE_ITEM,
                        authority: [ADMIN, USER],
                        subMenu: [],
            ...
            },
            {
                ...
                subMenu: [
                    ...
                    },
                    {
                        ...
                        title: 'Centred',
                        translateKey:
                            'nav.authentication.forgotPasswordCentred',
                        icon: '',
                        type: NAV_ITEM_TYPE_ITEM,
                        authority: [ADMIN, USER],
                        subMenu: [],
            ...
            },
            {
                ...
                subMenu: [
                    ...
                    },
                    {
                        ...
                        title: 'Centred',
                        translateKey: 'nav.authentication.resetPasswordCentred',
                        icon: '',
                        type: NAV_ITEM_TYPE_ITEM,
                        authority: [ADMIN, USER],
                        subMenu: [],
            ...
            },
            {
                ...
                subMenu: [
                    ...
                    },
                    {
                        ...
                        title: 'Centred',
                        translateKey:
                            'nav.authentication.otpVerificationCentred',
                        icon: '',
                        type: NAV_ITEM_TYPE_ITEM,
                        authority: [ADMIN, USER],
                        subMenu: [],
...
export default authDemoNavigationConfig
