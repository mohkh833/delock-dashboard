        ...
        subMenu: [
            {
                ...
                path: `https://static.themenate.net/eyris-doc/next/introduction/index.html`,
                isExternalLink: true,
                title: 'Documentation',
            ...
            },
            {
                ...
                path: `${GUIDE_PREFIX_PATH}/shared-component-doc/action-link`,
            ...
            {
                key: 'guide.utilsDoc',
                path: `${GUIDE_PREFIX_PATH}/utils-doc/use-authority`,
                title: 'Utilities',
