        ...
        subMenu: [
            {
                ...
                subMenu: [
                    ...
                    },
                    {
                        ...
                        title: 'Scroll',
                        translateKey: 'nav.uiComponentsCommon.scroll',
                        icon: 'uiCommonScroll',
                        type: NAV_ITEM_TYPE_ITEM,
                        authority: [ADMIN, USER],
                        meta: {
                            description: {
                                translateKey:
                                    'nav.uiComponentsCommon.scrollDesc',
            ...
            },
            {
                ...
                subMenu: [
                    ...
                    },
                    {
                        ...
                        title: 'Collapsible',
                        translateKey: 'nav.uiComponentsDataDisplay.collapsible',
                        icon: 'uiDataDisplayCollapsible',
                        type: NAV_ITEM_TYPE_ITEM,
                        authority: [ADMIN, USER],
                        meta: {
                            description: {
                                translateKey:
                                    'nav.uiComponentsDataDisplay.collapsibleDesc',
                    ...
                    },
                    {
                        ...
                        title: 'Popover',
                        translateKey: 'nav.uiComponentsDataDisplay.popover',
                        icon: 'uiDataDisplayPopover',
                        type: NAV_ITEM_TYPE_ITEM,
                        authority: [ADMIN, USER],
                        meta: {
                            description: {
                                translateKey:
                                    'nav.uiComponentsDataDisplay.popoverDesc',
                                label: 'Popup content cards',
                            },
                        },
                        subMenu: [],
                    },
            ...
            },
            {
                ...
                subMenu: [
                    ...
                    },
                    {
                        ...
                        translateKey: 'nav.uiComponentsForms.multiValueInput',
                        icon: 'uiFormsInput',
                        type: NAV_ITEM_TYPE_ITEM,
                        authority: [ADMIN, USER],
                        meta: {
                            description: {
                                translateKey:
                                    'nav.uiComponentsForms.multiValueInputDesc',
                                label: 'Tag-based inputs',
                            },
                        },
                        subMenu: [],
                    },
                ...
                subMenu: [
                    {
                        ...
                        title: 'Action Bar',
                        translateKey: 'nav.uiComponentsFeedback.actionBar',
                        icon: 'uiFeedbackActionBar',
                        type: NAV_ITEM_TYPE_ITEM,
                        authority: [ADMIN, USER],
                        meta: {
                            description: {
                                translateKey:
                                    'nav.uiComponentsFeedback.actionBarDesc',
                                label: 'Popup Action bar',
                            },
                        },
                        subMenu: [],
                    },
