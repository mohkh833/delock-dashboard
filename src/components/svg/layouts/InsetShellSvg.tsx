...
const InsetShellSvg = ({ className, ...rest }: SvgProps) => {
    return (
        <svg
            viewBox="0 0 170 110"
        ...
        >
            ...
            />
            <path
                d="M162.28 19H40.7202C39.7702 19 39 19.9402 39 21.1V100.9C39 102.06 39.7702 103 40.7202 103H162.28C163.23 103 164 102.06 164 100.9V21.1C164 19.9402 163.23 19 162.28 19Z"
