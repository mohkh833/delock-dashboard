...
const SystemSvg = ({ className, ...rest }: SvgProps) => {
    return (
        <svg
            viewBox="0 0 170 110"
            ...
            {...rest}
        >
            <path d="M0 0H85V110H0V0Z" className="fill-white" />
            <path d="M85 0H170V110H85V0Z" className="fill-neutral-900" />
            <path d="M0 0H85V11H0V0Z" className="fill-gray-100" />
            <path
            ...
            />
            <path d="M39 11H85V23H39V11Z" className="fill-white" />
            <path d="M85 11L170 11" className="stroke-neutral-800" />
            <path d="M0 11H85" className="stroke-gray-200" />
            <path d="M85 23L170 23" className="stroke-neutral-800" />
            <path d="M39 23H85" className="stroke-gray-200" />
            <path d="M39 11.3084L39 110" className="stroke-gray-200" />
            <path
