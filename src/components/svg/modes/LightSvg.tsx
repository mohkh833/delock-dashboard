...
const LightSvg = ({ className, ...rest }: SvgProps) => {
    return (
        <svg
            viewBox="0 0 170 110"
            ...
            {...rest}
        >
            <path d="M0 0H170V110H0V0Z" className="fill-white" />
            <path d="M0 0H170V11.3084H0V0Z" className="fill-gray-100" />
            <path
            ...
            />
            <path d="M0 11.3084H170" className="stroke-gray-200" />
            <path d="M39 22.6168L170 22.6168" className="stroke-gray-200" />
