...
const DarkSvg = ({ className, ...rest }: SvgProps) => {
    return (
        <svg
            viewBox="0 0 170 110"
            ...
            {...rest}
        >
            <path d="M0 0H170V110H0V0Z" className="fill-gray-900" />
            <path d="M0 0H170V11.3084H0V0Z" className="fill-gray-700" />
            <path
            ...
            />
            <path
                d="M39 11.3084H170V22.6168H39V11.3084Z"
                className="fill-gray-900"
            />
            <path d="M0 11.3084H170" className="stroke-gray-800" />
            <path d="M39 22.6168L170 22.6168" className="stroke-gray-800" />
            <path d="M39 11.3084L39 110" className="stroke-gray-800" />
            <path
