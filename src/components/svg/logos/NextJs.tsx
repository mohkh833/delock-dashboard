...
const NextJs = ({ height = 100, width = 100, ...rest }: SvgProps) => {
    return (
        <svg
        ...
        >
            <g transform="translate(.722 .64) scale(6.375)">
                ...
                <path
                    ...
                    fill="url(#nextjs_Linear1)"
                    className="[fill-rule:nonzero]"
                />
                <path
                    fill="url(#nextjs_Linear2)"
            ...
            <defs>
                ...
                >
                    <stop offset={0} className="[stop-color:#fff]" />
                    <stop
                        offset={1}
                        className="[stop-color:#fff] [stop-opacity:0]"
                    />
                </linearGradient>
                <linearGradient
                    id="nextjs_Linear2"
