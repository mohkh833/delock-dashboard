...
const HorizontalMenuDropdownTrigger = (
    ...
    const commonProps = {
        className: classNames(
            'font-medium inline-flex h-9 w-max items-center justify-center rounded-lg bg-background px-4 py-2 dark:text-gray-300 dark:hover:text-gray-100 text-gray-900 hover:bg-gray-100 dark:hover:bg-white/10 transition-colors',
            className,
            active &&
