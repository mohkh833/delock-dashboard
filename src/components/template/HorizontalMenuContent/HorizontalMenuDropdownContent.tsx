    ...
    return (
        <div
            className={classNames(
                'cursor-pointer font-medium px-2 rounded-lg flex items-center w-full whitespace-nowrap gap-x-2 transition-colors duration-150 hover:bg-gray-100 dark:hover:bg-gray-800',
...
const MenuLink = ({
    ...
    <HorizontalMenuNavLink
        ...
        onClick={onClick}
    >
        <MenuItem className="py-2 px-2 gap-2" active={active}>
            <div>
                <Avatar
                    className={classNames(
...
const ColumnsLayout = (
    ...
    return (
        <div className="flex max-w-[1400px] w-full">
            <div
                className={classNames(
                    'grid gap-y-2 gap-x-4 p-4 flex-1',
                        ...
                        return (
                            ...
                            >
                                <div className="max-w-[250px]">
                                    {showColumnTitle && (
                                        <div className="heading-text font-semibold mb-2">
                    ...
                    >
                        <ul>
                            ...
                            {nav.type === NAV_ITEM_TYPE_COLLAPSE && (
                                <Dropdown
                                    renderTitle={
                                        <span className="flex items-center gap-x-2 rounded-lg w-full whitespace-nowrap transition-colors duration-150 ">
                                            <MenuIcon icon={nav.icon} />
                                            <span>
                                                {t(nav.translateKey, nav.title)}
                                            </span>
    ...
    return (
        <div className="flex">
            ...
            {navigationTree.some(
                ...
                <div className="ltr:border-l rtl:border-r border-gray-200 dark:border-gray-800 p-4">
                    <div
                        className={classNames(
                            'grid gap-x-4 flex-1',
                            gridClasses[columns]?.grid,
...
const HorizontalMenuDropdownContent = (
    ...
    return (
        <div
            className="rounded-lg bg-white dark:bg-gray-900 ring-0 shadow-[0px_48px_64px_-16px_rgba(0,0,0,0.25)] border border-gray-200 dark:border-gray-700 focus:outline-hidden min-w-[220px] dropdown-menu"
            style={style}
        >
