...
const StatusIcon = ({ status }: { status: StatusType }) => {
    switch (status) {
        ...
        case 'success':
            return (
                <Avatar
                    className="bg-emerald-100 text-emerald-600 dark:bg-emerald-500/20 dark:text-emerald-100 border-0"
                    shape="circle"
                >
                    <span className="text-2xl">
                        <HiCheckCircle />
        ...
        case 'warning':
            return (
                <Avatar
                    className="text-amber-600 bg-amber-100 dark:text-amber-100 dark:bg-amber-500/20 border-0"
                    shape="circle"
                >
                    <span className="text-2xl">
                        <HiOutlineExclamationCircle />
...
const ConfirmDialog = (props: ConfirmDialogProps) => {
    ...
    return (
        <Dialog className="pb-0 px-0" closable={closable} {...rest}>
