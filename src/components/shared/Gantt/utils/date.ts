...
import { Task, ViewMode as ViewModeType } from '../types'
...
export const getCachedDateTimeFormat = (
    ...
    let dateTimeFormat = intlDTCache[key]
    if (!dateTimeFormat) {
        dateTimeFormat = new Intl.DateTimeFormat(locString, opts)
        intlDTCache[key] = dateTimeFormat
    }
