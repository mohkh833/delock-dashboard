                ...
                >
                    <div className="flex flex-col">
                        ...
                        >
                            ...
                            <div
                                className={classNames(
                                    'bubble flex flex-col justify-center h-full max-w-[750px] rounded-xl px-4 py-2 bg-gray-100 dark:bg-gray-700 prose text-sm text-gray-900 dark:text-gray-100',
                                    bubbleClass,
                                )}
                            >
                                {customRenderer ? (
