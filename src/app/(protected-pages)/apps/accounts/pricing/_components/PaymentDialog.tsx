...
const PaymentDialog = () => {
    ...
    const handleManageSubscription = async () => {
        router.push('/apps/accounts/settings/billing?view=billing')
            ...
            {paymentSuccessful ? (
                <>
                    <div className="text-center mt-6 mb-2">
                        <div className="inline-flex rounded-full p-3 bg-success">
                            <TbCheck className="text-3xl text-white" />
                        </div>
                        <div className="mt-6">
                ...
                <>
                    <h5 className="mt-1">{selectedPlan.planName} plan</h5>
                    <div className="mt-6">
                        <Segment
                                            ...
                                            return (
                                                <div
                                                    className={classNames(
                                                        'flex justify-between border rounded-xl border-gray-300 dark:border-gray-600 py-4 px-4 select-none ring-1 w-1/2',
                                                        active
