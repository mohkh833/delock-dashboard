...
type ImageGeneratorState = {
    ...
    generatedImage: Array<{ id: string; prompt: string; gallery: Gallery }>
...
export const useAiImageStore = create<
...
>((set, get) => ({
    ...
    setGeneratedImage: (payload) =>
        set(() => {
            const generatedImage = get().generatedImage
            generatedImage.unshift(payload)
