...
const ChatCustomAction = ({ content }: ChatCustomActionProps) => {
    ...
    const btnClass =
        'p-2 hover:text-gray-900 dark:hover:text-gray-100 transition-colors duration-300 ease-in-out rounded-full'
    ...
    const handleDialogClose = () => {
        setResponseDialog({ type: '', open: false })
    }
    ...
    return (
        <>
            ...
            <Dialog isOpen={responseDialog.open} onClose={handleDialogClose}>
