...
import ColumnVerticalLine from './ColumnVerticalLine'
...
const demos = [
    ...
    {
        mdName: 'ColumnVerticalLine',
        mdPath: mdPath,
        title: 'Column Vertical Line',
        desc: `Vertical line can be added between columns, header and body`,
        component: <ColumnVerticalLine />,
    },
    {
        mdName: 'WithBorder',
        mdPath: mdPath,
        title: 'With Border',
        desc: `Use <code>bordered</code> prop to make tables wrapped with border.`,
...
const demoApi = [
    {
        ...
        api: [
            ...
            },
            {
                ...
                desc: 'Whether display table with border',
            },
            {
                propName: 'compact',
                type: `<code>boolean</code>`,
            ...
            {
                propName: 'overflowClass',
                type: `<code>string</code>`,
                default: `-`,
                desc: 'Class name to be added when table content overflow',
            },
            {
                propName: 'verticalDivider',
                type: `<code>{ head?: boolean; body?: boolean; foot?: boolean }</code>`,
                default: `<code>true</code>`,
                desc: 'Whether display vertical line between columns',
            },
        ],
    },
    {
