...
const demos = [
    {
		...
		value to <code>default</code>, <code>solid</code>, <code>muted</code> or <code>link</code>.`,
        component: <Variant />,
    },
    {
        mdName: 'Size',
    ...
    },
    {
        ...
        mdPath: mdPath,
        title: 'Custome style',
        desc: `Use <code>className</code> props callback to apply custom style`,
        component: <Color />,
    },
    {
        mdName: 'Disabled',
...
const demoApi = [
    {
        ...
        api: [
            ...
            {
                propName: 'className',
                type: `<code>string | (state: {active: boolean, unclickable: boolean}) => string</code>`,
                default: '-',
                desc: 'Custom class name for the button',
            },
            {
