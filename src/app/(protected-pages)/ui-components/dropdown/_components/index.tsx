...
const demos = [
    ...
    },
    {
        ...
        mdPath: mdPath,
        title: 'Trigger',
        desc: `Dropdown allow us to set<code>trigger</code> mode to <code>click</code>, <code>hover</code> or <code>rightClick</code>.`,
        component: <Trigger />,
    },
    {
        mdName: 'Submenu',
    ...
    },
    {
        ...
        mdPath: mdPath,
        title: 'Context Menu',
        desc: `Dropdown can be used as context menu.`,
...
const demoApi = [
    ...
    {
        component: 'Dropdown.ContextMenu',
        api: [
            {
                propName: 'areaClass',
                type: `<code>string</code>`,
                default: `-`,
                desc: 'Additional class for dropdown area',
            },
            {
                propName: 'areaContent',
                type: `<code>ReactNode</code>`,
                default: `-`,
                desc: 'Additional content for dropdown area',
            },
            {
                propName: 'areaRef',
                type: `<code>Ref&lt;HTMLDivElement&gt;</code>`,
                default: `-`,
                desc: 'Ref object to access the internal dropdown area.',
            },
            {
                propName: 'placement',
                type: `<code>'top-start'</code> | <code>'top-center'</code> | <code>'top-end'</code> | <code>'bottom-start'</code> | <code>'bottom-center'</code> | <code>'bottom-end'</code> | <code>'middle-start-top'</code>| <code>'middle-start-bottom'</code> | <code>'middle-end-top'</code>| <code>'middle-end-bottom'</code>`,
