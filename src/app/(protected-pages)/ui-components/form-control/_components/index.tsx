...
const formikNote = (
    <div>
        ...
        <p className="mt-2">
            ...
            data type, from a simple string to a complex nested object. Zod is
            designed to be as developer-friendly as possible. The goal is to
            eliminate duplicative type declarations. With Zod, you declare a
            validator once and Zod will automatically infer the static
            TypeScript type. It&apos;s easy to compose simpler types into
            complex data structures. Visit the official
            <a
                className="underline text-primary"
                href="https://zod.dev/"
                target="_blank"
