        ...
        api: [
            {
                ...
                default: `-`,
                desc: 'Initial value for uncontrolled Segment, string for single selection and string[] for multiple selection',
            },
            {
                propName: 'onChange',
                type: `<code>(segmentValue: string | string[]) => void</code>`,
                default: `-`,
                desc: 'Callback when Segment value is changed, string for single selection and string[] for multiple selection',
            },
            {
            ...
            },
            {
                ...
                type: `<code>string | string[]</code>`,
                default: `-`,
                desc: 'Controlled value of the Segment item to activate, string for single selection and string[] for multiple selection',
            },
        ],
    },
    {
