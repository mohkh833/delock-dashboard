...
export async function POST(request: NextRequest) {
    ...
    if (userPrompt.includes('title')) content = responseContents.title
    if (userPrompt.includes('code')) content = responseContents.code
    if (userPrompt.includes('list')) content = responseContents.list
